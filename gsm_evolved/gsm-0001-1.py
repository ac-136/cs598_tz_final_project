...
if __name__ == "__main__":
    ...
    # output jsonl file
    with open(f'./output/gsm_evolved_20.jsonl', 'a') as f:
        for i in range(NUM_PROBLEMS):
            problem, solution_code, result, solution_wocode = generate_problem_and_solution_code()
            # Write problem to file
            f.write(json.dumps({"problem": problem, "solution_code": solution_code, "solution_wocode": solution_wocode, "result": str(result), "template_name": "gsm-0001-1", "idx": i}) + '\n')
