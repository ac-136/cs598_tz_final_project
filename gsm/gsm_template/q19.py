### Code adapted from https://github.com/yifanzhang-pro/syntax-semantics/blob/main/template-gsm/gsm-0019-1.py

# Origin problem: {"question": "Tim rides his bike back and forth to work for each of his 5 workdays.  
...
if __name__ == "__main__":
    ...
    # output jsonl file
    with open(f'./output/q19--NUM{NUM_PROBLEMS}.jsonl', 'w') as f:
        for i in range(NUM_PROBLEMS):
            problem, result = generate_problem_and_solution_code()
            # Write problem to file
            f.write(json.dumps({"problem": problem, "result": str(result), "template_name": 19, "idx": i}) + '\n')